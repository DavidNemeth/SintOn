#pragma checksum "C:\Users\Dave\Documents\Repositories\SintOn\Views\Busy.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "BC5EB9ADB174F9F04D4CD0C678548D93"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace SintOn.Views
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class Busy_obj1_Bindings :
            ...
            IBusy_Bindings
        {
            private global::SintOn.Views.Busy dataRoot;
            ...
            public void SetDataRoot(global::SintOn.Views.Busy newDataRoot)
            {
                this.bindingsTracking.ReleaseAllListeners();
            ...
            private void Update_(global::SintOn.Views.Busy obj, int phase)
            {
            ...
            private class Busy_obj1_BindingsTracking
            {
                ...
                public void DependencyPropertyChanged_IsBusy(global::Windows.UI.Xaml.DependencyObject sender, global::Windows.UI.Xaml.DependencyProperty prop)
                {
                    ...
                    {
                        global::SintOn.Views.Busy obj = sender as global::SintOn.Views.Busy;
        if (obj != null)
        {
        ...
        bindings.UpdateFallback_BusyText(DATA_CHANGED);
                ...
                public void UpdateChildListeners_(global::SintOn.Views.Busy obj)
                {
                    Busy_obj1_Bindings bindings;
                    if(WeakRefToBindingObj.TryGetTarget(out bindings))
                    {
                        ...
                        {
                            bindings.dataRoot.UnregisterPropertyChangedCallback(global::SintOn.Views.Busy.IsBusyProperty, tokenDPC_IsBusy);
                            bindings.dataRoot.UnregisterPropertyChangedCallback(global::SintOn.Views.Busy.BusyTextProperty, tokenDPC_BusyText);
                        }
                        if (obj != null)
                        {
                            bindings.dataRoot = obj;
                            tokenDPC_IsBusy = obj.RegisterPropertyChangedCallback(global::SintOn.Views.Busy.IsBusyProperty, DependencyPropertyChanged_IsBusy);
                            tokenDPC_BusyText = obj.RegisterPropertyChangedCallback(global::SintOn.Views.Busy.BusyTextProperty, DependencyPropertyChanged_BusyText);
                        }
                    }
                }
            }
